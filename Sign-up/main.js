function getInfo() {
    ...
    xhttp.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
            ...
            document.getElementsByClassName('validation-element').innerText = info.text
        }
    }
    xhttp.open("GET", "https://signup-5577a-default-rtdb.asia-southeast1.firebasedatabase.app/info.json", true)
    xhttp.send()
}
getInfo()
